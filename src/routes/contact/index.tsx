    ...
    <div className={styles.contactContainer}>
      ...
      <form onSubmit={onSubmit} name="contact" data-netlify="true" method="POST">
        ...
        <div className={styles.fieldGroup}>
          ...
          <input type="text" name="name" id="name" value={formState.name.value} onChange={onFieldChange} />
        ...
        <div className={`${styles.fieldGroup}`}>
          <div className={styles.contactFieldsContainer}>
            <div className={styles.fieldGroup}>
              ...
              <input type="email" name="emailAddress" id="emailAddress" value={formState.emailAddress.value} onChange={onFieldChange} />
            </div>
            <div className={styles.orText}>or</div>
            <div className={styles.fieldGroup}>
              <label htmlFor="phoneNumber">Phone number:</label>
              <input type="tel" name="phoneNumber" id="phoneNumber" value={formState.phoneNumber.value} onChange={onFieldChange} />
            </div>
          </div>
        ...
        <div className={styles.fieldGroup}>
          ...
          <input type="text" name="postcode" id="postcode" value={formState.postcode.value} onChange={onFieldChange} />
